        ...
        <div className="mx-auto flex min-h-[calc(100vh-88px)] w-full max-w-4xl flex-col px-4 pb-16">
          <div className="flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="rounded-2xl border border-border/60 bg-card/80 backdrop-blur-xl p-6 sm:p-8 shadow-2xl shadow-primary/5 max-w-lg mx-auto w-full"
            >
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <input
                  ...
                  className="flex-1 rounded-xl border border-border bg-background px-4 py-3.5 text-base font-mono tracking-wider uppercase outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all placeholder:text-muted-foreground/50 placeholder:font-sans placeholder:tracking-normal placeholder:normal-case"
                />
                ...
                <Link href={href} className="sm:w-auto">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="group w-full sm:w-auto rounded-xl bg-linear-to-r from-primary to-primary/80 px-6 py-3.5 font-semibold text-primary-foreground shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all flex items-center justify-center gap-2"
                    type="button"
                  >
                    Join Room
              ...
              <div className="mt-6 pt-6 border-t border-border/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            >
              {features.map((f, i) => (
                <motion.div
                  ...
                  className="group rounded-xl border border-border/50 bg-card/50 backdrop-blur-sm p-4 text-center hover:border-primary/30 hover:bg-card/80 transition-all"
                >
