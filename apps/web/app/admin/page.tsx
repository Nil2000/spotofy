      ...
      <div className="relative">
        ...
        <nav className="p-4 sm:p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              className="bg-green-500 hover:bg-green-700/90 text-white"
              variant={"outline"}
            >
          ...
          >
            {stats.map((stat, i) => (
              <motion.div
                ...
                className="rounded-xl border border-border/60 bg-card/80 backdrop-blur-xl p-4 text-center"
              >
              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-2 mb-6">
                  ...
                  <div className="rounded-xl border border-border/50 bg-background/50 p-4">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-amber-500" />
                      <p className="font-semibold">Not linked</p>
                    </div>
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="flex-1 rounded-xl bg-linear-to-r from-primary to-primary/80 px-5 py-3.5 font-semibold text-primary-foreground shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all flex items-center justify-center gap-2"
                    type="button"
                  >
