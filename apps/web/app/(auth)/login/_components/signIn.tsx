      ...
      <div className="rounded-2xl border border-border/60 bg-card/80 backdrop-blur-xl p-6 sm:p-8 shadow-2xl shadow-primary/5">
        ...
        <div className="space-y-4">
          <motion.button
            ...
            className="group flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-background px-4 py-3.5 font-medium text-foreground transition-all hover:bg-muted hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 disabled:cursor-not-allowed disabled:opacity-50"
            type="button"
          >
            {loading ? (
